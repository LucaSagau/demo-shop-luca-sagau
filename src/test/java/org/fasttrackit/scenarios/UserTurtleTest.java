...
public class UserTurtleTest extends TestConfiguration {
    ...
    @Test(testName = "Verify user turtle can add products in wishlist.",
            description = "This test verify if user turtle can add products in wishlist.")
    public void userTurtleCanAddProductsInWishlist() {
        Account account = new Account("turtle", "choochoo");
        homePage.clickOnTheSignInButton();
        Modal modal = new Modal();
        modal.typeInUserNameField(account.getUsername());
    ...
    @Test(testName = "Verify user turtle can increase number of products in cart.",
            description = "This test verify if user turtle can increase number of products in cart.")
    public void userTurtleCanIncreaseNumberOfProductsInCart() {
        Account account = new Account("turtle", "choochoo");
        homePage.clickOnTheSignInButton();
        Modal modal = new Modal();
        modal.typeInUserNameField(account.getUsername());
    ...
    @Test(testName = "Verify user turtle can decrease number of products in cart.",
            description = "This test verify if user turtle can decrease number of products in cart.")
    public void userTurtleCanDecreaseNumberOfProductsInCart() {
        Account account = new Account("turtle", "choochoo");
        homePage.clickOnTheSignInButton();
        Modal modal = new Modal();
        modal.typeInUserNameField(account.getUsername());
